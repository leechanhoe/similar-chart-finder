...
blueprints = [kospi_daq_bp, kospi_daq_bp_hyphen, nyse_naq_bp, nyse_naq_bp_hyphen,
               stock_info_bp, stock_bp, result_bp, statistics_bp, secret_bp, api_bp, 
               pattern_search_bp, validation_bp]
...
def notice():
    lang = 'ko'
    return render_template('privacy_policy.html', translations=translations[lang], lang=lang)